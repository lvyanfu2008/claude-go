...
| 功能 | 说明 |
|------|------|
| 双屏 `Screen = 'prompt' \| 'transcript'` | 主会话 vs 转写/冻结视图 |
...
| `streamingToolUses`、`streamingThinking` | 流式工具调用、thinking |
...
| `TranscriptSearchBar`、`useSearchHighlight`、`jumpRef` | `/` 搜索、`n`/`N`、Esc 与高亮 |
