...
func TestSearchReadSummaryText_readOnly(t *testing.T) {
	got := SearchReadSummaryText(false, 0, 2, 0, 0, 0, 0, 0, nil, nil, nil)
	if got != "Read 2 files" {
		t.Fatalf("got %q", got)
	}
}
...
func TestSearchReadSummaryText_searchAndRead(t *testing.T) {
	got := SearchReadSummaryText(false, 1, 2, 0, 0, 0, 0, 0, nil, nil, nil)
...
func TestSearchReadSummaryText_activeTrailingEllipsis(t *testing.T) {
	got := SearchReadSummaryText(true, 1, 0, 0, 0, 0, 0, 0, nil, nil, nil)
...
func TestSearchReadSummaryText_listRepl(t *testing.T) {
	got := SearchReadSummaryText(false, 0, 0, 2, 3, 0, 0, 0, nil, nil, nil)
...
func TestSearchReadSummaryText_memory(t *testing.T) {
	got := SearchReadSummaryText(false, 0, 0, 0, 0, 1, 0, 0, nil, nil, nil)
...
func TestSearchReadSummaryText_teamMemory(t *testing.T) {
	tr := 2
	got := SearchReadSummaryText(false, 0, 0, 0, 0, 0, 0, 0, &tr, nil, nil)
...
func TestSearchReadSummaryText_empty(t *testing.T) {
	got := SearchReadSummaryText(false, 0, 0, 0, 0, 0, 0, 0, nil, nil, nil)
	if got != "" {
		t.Fatalf("got %q", got)
	}
}
