...
func slashPickerListRows(vis []string, maxListRows int) int {
	return input.SlashPickerListRows(vis, maxListRows)
}
...
func slashPickerMaxListRows(termHeight int) int {
	return input.SlashPickerMaxListRows(termHeight)
}

// renderSlashPicker delegates to input.RenderSlashPicker.
func (m *model) renderSlashPicker(width, termHeight int) string {
	return input.RenderSlashPicker(inputDeps{m}, width, termHeight)
}
