...
4. If a tab is closed by the user or a navigation error occurs, call tabs_context_mcp to see what tabs are available
...
func resolveClaudeInChrome(args string) types.SlashResolveResult {
	body := chromeBundledBody
