...
1. **Prerequisites**
   ...
   - **Load steering documents**: 
     ```bash
     # Windows:
     claude-code-spec-workflow get-content "C:\path\to\project\.harness\steering\tech.md"
     claude-code-spec-workflow get-content "C:\path\to\project\.harness\steering\structure.md"
     
     # macOS/Linux:
     claude-code-spec-workflow get-content "/path/to/project/.harness/steering/tech.md"
     claude-code-spec-workflow get-content "/path/to/project/.harness/steering/structure.md"
     ```
...
## Template Usage
- **Follow exact structure**: Use `.harness/templates/bug-analysis-template.md` precisely
