...
- Supported files (recursive):
  ...
  - **`*.md`**: SKILL-style YAML frontmatter + markdown body (same as `.harness/skills`). For `subdir/SKILL.md`, the command name is `subdir`. For other `*.md` files, the name is the file stem.
