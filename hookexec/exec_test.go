...
func TestExtractPluginRoot(t *testing.T) {
	tests := []struct {
		...
		{
			cmd:  `"/Users/lv/.claude/plugins/cache/claude-plugins-official/superpowers/5.1.0/hooks/run-hook.cmd" session-start`,
			want: "/Users/lv/.claude/plugins/cache/claude-plugins-official/superpowers/5.1.0",
		},
		{
			cmd:  `/home/user/.claude/plugins/cache/local/my-plugin/2.0.0/hooks/session-start`,
