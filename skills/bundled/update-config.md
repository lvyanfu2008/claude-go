...
```json
{
  ...
  "properties": {
    ...
    "modelType": {
      "description": "API provider type. \"anthropic\" uses the Anthropic API (default), \"openai\" uses the OpenAI Chat Completions API (/v1/chat/completions). When set to \"openai\", configure OPENAI_API_KEY, OPENAI_BASE_URL, and OPENAI_MODEL in env.",
      "type": "string",
      "enum": [
        "anthropic",
        "openai"
